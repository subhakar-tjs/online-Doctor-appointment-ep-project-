  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="userafterlogin.jsp">Home <span class="sr-only">(current)</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="https://infodoctor.in/">Contact</a>
      </li>
    </ul>
    ...
    <div class="mask">
      <div class="d-flex justify-content-top-center align-items-left h-100">
        <div class="text-black">
          ...
          <h4 class="mb-3">CHECK ACTIVE APPOINTMENTS NOW</h4>
          <a class="btn btn-outline-dark btn-lg" href="appointment.jsp" role="button">CHECK APPOINTMENTS</a>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled">
          ...
          <li>
            <a href="https://infodoctor.in/" class="text-white">Contact</a>
          </li>
          <li>
